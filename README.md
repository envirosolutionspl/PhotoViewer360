...
## Uwaga
Do wtyczki załączono również dane w folderze [test_data](https://downloads.envirosolutions.pl/photoviewer360_test_data.zip) w formacie ZIP, które umożliwiają testowanie funkcjonalności narzędzia.
...
## Attention
The plugin also includes data in the [test_data](https://downloads.envirosolutions.pl/photoviewer360_test_data.zip) folder in ZIP format, which enables testing of the tool’s functionality.
